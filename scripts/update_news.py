...
- For manual source files: if the file already contains a complete, detailed article (with a clear body of more than 150 words), copy the original Portuguese and English text exactly as written. If the manual source file is a short draft, note, or lacks a proper detailed body, you MUST expand it into a detailed, professional, and dry analysis of at least 220 to 300 words (minimum 220 words) for both the Portuguese and English body fields (body_pt and body_en). Write a serious, high-quality expansion of the provided facts, explaining their broader context and implications, without inventing any unsupplied details.
...
- For all stories (both manual and RSS), the summary (summary_pt and summary_en) MUST be a concise 2-sentence summary to maintain a clean website layout and visual graphics. Never copy the full article text into the summary fields.
